...
recipes = [
    ...
    {
        name: "CannaButter",
        ingredient: "1 cup of butter, -1 cup (7-10 grams) of ground cannabis, decarboxylated",
        ...
        image: "https://leafly-cms-production.imgix.net/wp-content/uploads/2014/03/29200228/recipe-how-to-make-basic-cannabutter.jpg"
    },
    {
    ...
    },
    {
        ...
        image: "https://www.thecannaschool.ca/wp-content/uploads/2019/12/Canva-churros-with-sugar-2048x1356.jpg"
    },
    {
    ...
    },
    {
        ...
        6. Serve.",
        image: "https://www.cannadish.net/wp-content/uploads/2019/10/Weed-infused-tuna-salad-with-toast.jpg"
    },

    {
        ...
        image: "https://lacannabisreviews.com/wp-content/uploads/2019/12/Take-Breakfast-To-The-Next-Level-With-This-THC-French-Toast.jpg"
    },
...
reviews = [
    ...
    },
    {
        ...
        recipe_id:Recipe.all[9].id,
        rating: 4,
        comment:"my husband has terrible back pain and he loves this recipe! effective and delicious"
    },
    {
        user_id: User.fifth.id,
        recipe_id:Recipe.all[12].id,
        rating: 5,
        comment:"WHAT A DREAM!"
    },
    {
